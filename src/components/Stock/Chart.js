...
export default class Chart extends Component {
    ...
    initChart = () => {
        ...
        var Zend = 100;
        var KNAME;
        var data = splitData(this.props.data);
        console.log(data);
        var MA1 = 0,
            MA2 = 0,
            MA3 = 0,
        ...
        this.props.room.onMessage((message) => {
            ...
            switch (message.action) {
                ...
                case 'main':
                    ...
                    // if (dataFormat.datas[0][0] !== data.datas[0][0]) {
                    // data.datas.shift();
                    // data.times.shift();
                    // data.vols.shift();
                    // data.datas.push(dataFormat.datas[dataFormat.datas.length - 1]);
                    // data.times.push(dataFormat.times[dataFormat.times.length - 1]);
                    // data.vols.push(dataFormat.vols[dataFormat.vols.length - 1]);

                    // data.datas = [...data.datas, ...dataFormat.datas];
                    // data.times = [...data.times, ...dataFormat.times];
                    // data.vols = [...data.vols, ...dataFormat.vols];
                    ...
                    instance.setOption({
                        series: [
                            {
                                data: dataFormat.datas,
                                markLine: {
                                    "data": [{
                                        "yAxis": dataFormat.datas[dataFormat.datas.length - 1][1],

                                        "label": {
                                            formatter: function (d) {
                                                return dataFormat.datas[dataFormat.datas.length - 1][1].toFixed(2).replace(/\d(?=(\d{3})+\.)/g, "$&,") +
                                                    '\n'
                                                    + dataFormat.times[dataFormat.times.length - 1];
                                            },
                                            "show": true,
                                            "color": "black",
                                            "position": window.innerWidth <= 768 ? "insideMiddleBottom" : "center",
                                            ...
                                            "padding": 2,
                                            "borderRadius": 5,
                                            "backgroundColor": dataFormat.datas[dataFormat.datas.length - 1][1] - dataFormat.datas[dataFormat.datas.length - 2][1] == 0 ? "orange" : dataFormat.datas[dataFormat.datas.length - 1][1] - dataFormat.datas[dataFormat.datas.length - 2][1] > 0 ? color1 : color2,
                                        },
                                        "lineStyle": {
                                            "color": dataFormat.datas[dataFormat.datas.length - 1][1] - dataFormat.datas[dataFormat.datas.length - 2][1] == 0 ? "orange" : dataFormat.datas[dataFormat.datas.length - 1][1] - dataFormat.datas[dataFormat.datas.length - 2][1] > 0 ? color1 : color2,
                                            "width": 1,
                                            "type": "dashed"
                                        },
                                    },]
                            ...
                            {
                                data: MA(3, dataFormat.datas, 1)[0],
                            },
                            {
                                data: MA(5, dataFormat.datas, 1)[0],
                            },
                            {
                                data: MA(10, dataFormat.datas, 1)[0],
                            },
                            {
                                data: spitColor(dataFormat),
                                markLine: {
                                    "symbol": "",
                                    "data": [{
                                        "yAxis": dataFormat.vols[dataFormat.vols.length - 1],
                                        ...
                                        "label": {
                                            ...
                                            "padding": 3,
                                            "borderRadius": 5,
                                            "backgroundColor": dataFormat.datas[dataFormat.vols.length - 1] - dataFormat.datas[dataFormat.vols.length - 2] == 0 ? "orange" : dataFormat.datas[dataFormat.datas.length - 1][1] - dataFormat.datas[dataFormat.datas.length - 2][1] > 0 ? color1 : color2,
                                        },
                                        "lineStyle": {
                                            "color": dataFormat.datas[dataFormat.vols.length - 1] - dataFormat.datas[dataFormat.vols.length - 2] == 0 ? "orange" : dataFormat.datas[dataFormat.datas.length - 1][1] - dataFormat.datas[dataFormat.datas.length - 2][1] > 0 ? color1 : color2,
                                            "width": 1,
                                            "type": "dashed"
                                        },
                                    },]
